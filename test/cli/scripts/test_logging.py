...
class LoggerUtilTest(test.DeleteResourceTest):
    ...
    def test_properties(self):
        for k, v in {
            'directory': os.path.abspath(LoggerProperties.CONFIG_DIR + '/logging'), 'log_file': 'main.log', 'error_file': 'error.log'
        }.items():
    ...
    def test_main_log_file_created_when_info(self):
        ...
        self.assertTrue(os.path.exists(os.path.abspath(
            LoggerProperties.CONFIG_DIR + '/logging' + '/main.log')))
    ...
    def test_error_log_file_created_when_error(self):
        ...
        self.assertTrue(os.path.exists(os.path.abspath(
            LoggerProperties.CONFIG_DIR + '/logging' + '/error.log')))
